...
`,lC=j.div`
  ...
  font-weight: 600;
  color: #ffde00;
`,oC=new URL("/vegetaquizshow/assets/Pokemon%20Mystery%20Dungeon%20Red_Blue%20Rescue%20Team%20Full%20OST%20_6EHwdMQj3i4_00_00_00_00_05_00_part_-CfduThOI.mp3",import.meta.url).href,uC=new URL("/vegetaquizshow/assets/welcome-pokemon-Boc2-QOp.mp3",import.meta.url).href,cC=new URL("/vegetaquizshow/assets/abtn-DX_bwNuP.mp3",import.meta.url).href,Fr={"/":uC,"/game":oC},fC=A.createContext({isPlaying:!1,volume:.5,toggleAudio:()=>{},changeVolume:n=>{},currentAudioPath:""}),dC=()=>{const{pathname:n}=fa(),[i]=A.useState(new Audio),[s,l]=A.useState(!1),[u,f]=A.useState(.5),[d,m]=A.useState(!1),[h,p]=A.useState(""),v=A.useRef(null),[y,x]=A.useState(!0),E=A.useRef(new Audio(cC));A.useEffect(()=>{E.current.volume=.2;const P=localStorage.getItem("pokemonQuizClickSoundEnabled");P!==null&&x(P==="true")},[]);const S=()=>{const P=!y;x(P),localStorage.setItem("pokemonQuizClickSoundEnabled",String(P))},C=()=>{if(y){const P=E.current.cloneNode();P.volume=.1,P.play().catch(N=>console.log("Click sound error:",N))}};A.useEffect(()=>{const P=()=>C();return document.addEventListener("mousedown",P),()=>{document.removeEventListener("mousedown",P)}},[y]);const D=()=>{s?(i.pause(),l(!1),localStorage.setItem("pokemonQuizAudioEnabled","false")):(i.volume=u,i.loop=!0,i.play().then(()=>{l(!0),localStorage.setItem("pokemonQuizAudioEnabled","true")}).catch(P=>console.log("Audio playback error:",P)))},M=P=>{const N=parseFloat(P.toFixed(2));f(N),i.volume=N,localStorage.setItem("pokemonQuizAudioVolume",N.toString())},L=P=>{if(Fr[P])return Fr[P];for(const N in Fr)if(P.startsWith(N)&&N!=="/")return Fr[N];return Fr["/"]};A.useEffect(()=>{const P=localStorage.getItem("pokemonQuizAudioEnabled")==="true",N=localStorage.getItem("pokemonQuizAudioVolume");if(N){const Y=parseFloat(N);f(Y),i.volume=Y}else i.volume=u;P&&l(!0)},[i]),A.useEffect(()=>{const P=L(n);if(P!==h){const N=!i.paused;i.currentTime,i.src=P,p(P),N&&s&&i.play().catch(Y=>console.log("Audio playback error:",Y))}else s&&i.paused&&i.play().catch(N=>console.log("Audio playback error:",N))},[n,i,s,h]),A.useEffect(()=>{const P=N=>{v.current&&!v.current.contains(N.target)&&m(!1)};return document.addEventListener("mousedown",P),()=>{document.removeEventListener("mousedown",P)}},[]);const V=()=>u===0||!s?w.jsx(C3,{}):u<.5?w.jsx(A3,{}):w.jsx(M3,{});return w.jsx(fC.Provider,{value:{isPlaying:s,volume:u,toggleAudio:D,changeVolume:M,currentAudioPath:h},children:w.jsxs(mC,{ref:v,children:[w.jsxs("div",{className:"container",children:[w.jsx(pC,{onClick:D,onMouseEnter:()=>m(!0),title:s?"Disattiva musica":"Attiva musica",children:V()}),w.jsx(gC,{$visible:d,children:w.jsx(vC,{type:"range",min:"0",max:"0.3",step:"0.01",value:u,onChange:P=>M(parseFloat(P.target.value))})})]}),w.jsx(yC,{onClick:S,$active:y,title:y?"Disattiva suono click":"Attiva suono click",children:w.jsx(x3,{})})]})})},hC=()=>w.jsxs(I5,{basename:"/vegetaquizshow",children:[w.jsx(dC,{}),w.jsxs(D5,{children:[w.jsx(Mi,{path:"/",element:w.jsx(D3,{})}),w.jsx(Mi,{path:"/game",element:w.jsx(hS,{})}),w.jsx(Mi,{path:"/game/categories",element:w.jsx(xT,{})}),w.jsx(Mi,{path:"/game/wheel",element:w.jsx(oA,{})}),w.jsx(Mi,{path:"/game/image",element:w.jsx(wA,{})})]})]}),mC=j.div`
  position: fixed;
  bottom: 20px;
  left: 20px;
  display: flex;
